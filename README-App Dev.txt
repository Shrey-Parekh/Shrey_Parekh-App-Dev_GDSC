...
a proper platform to share time, knowledge, hobbies, ideas, learnings, intrests etc with each other. 
1. The User starts the application and logs into the app, user can reset their password. 
2. Then the user has to make hi profile, by adding their Profile picture, thier course, field of study and year of study.
3. User Can then access the home page, the home page will consist of many things:
	...
	vii. Users can participate into any compitions 
...
4. Users can logout and quit the app but, the app ask for reviews from the users. 